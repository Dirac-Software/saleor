...
@pytest.mark.e2e
def test_draft_order_with_voucher_fixed_entire_order_CORE_0928(
    e2e_staff_api_client,
    shop_permissions,
    ...
    # Step 4 - Add voucher for subtotal
...
@pytest.mark.e2e
def test_draft_order_with_voucher_percentage_entire_order_CORE_0929(
    e2e_staff_api_client,
    shop_permissions,
    permission_manage_product_types_and_attributes,
    permission_manage_discounts,
